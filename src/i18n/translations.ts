...
export const translations = {
  ar: {
    ...
    about: {
      ...
      bio1: 'أنا <strong class="text-white">مطور واجهات أمامية ومطور شامل (Full-Stack & Frontend)</strong> أركز على بناء تجارب رقمية عالية الأداء. متخصص في استخدام <span class="font-[500] text-[var(--color-primary)]">Angular, Tailwind CSS, PrimeNG و Node.js</span>، وأقوم بتصميم واجهات قابلة للتوسع وتحسين بيئات التجارة الإلكترونية مثل Shopify.',
...
منصة رعاية صحية وإكلينيكية متخصصة للاستشارات الطبية ورعاية المرضى، مع واجهة مستخدم نظيفة وتجربة حجز واستعلام سلسة.
  ...
  en: {
    ...
    about: {
      ...
      bio1: 'I am a <strong class="text-white">Full-Stack & Frontend Developer</strong> focused on building high-performance digital experiences. Specializing in <span class="font-[500] text-[var(--color-primary)]">Angular, Tailwind CSS, PrimeNG and Node.js</span>, I design scalable interfaces and optimize E-commerce environments like Shopify.',
